...
import styles from './MainJS.module.scss'
import icon1 from './icon/binance-usd-(busd)-min.png'
import icon2 from './icon/code-circle-min.png'
import icon3 from './icon/js-min.png'
import icon4 from './icon/share-min.png'
import icon5 from './icon/toggle-off-circle-min.png'
import icon6 from './icon/Vector-min.png'
			...
			<div className={styles.main__block}>
				<div className={styles.main__block__left}>
					...
					<div className={styles.main__block__left__info}>
						<div>
							<p>{t('js.info.leftOne')}</p>
							<p>{t('js.info.leftTwo')}</p>
						</div>
						<div>
							<p>{t('js.info.middleOne')}</p>
							<p>{t('js.info.middleTwo')}</p>
						</div>
						<div>
							<p>{t('js.info.rightOne')}</p>
							<p>{t('js.info.rightTwo')}</p>
						</div>
					</div>
					<div className={styles.main__block__icon}>
						<div className={styles.main__block__icon__block}>
							...
							<div className={styles.main__block__icon__i}></div>
							<div>
				...
				<div className={styles.main__block__middle}>
					<div>
						<div className={styles.main__block__middle__left}>
							<h2>{t('js.infoMiddle.title')}</h2>
							<p>{t('js.infoMiddle.infoOne')}</p>
							<p>{t('js.infoMiddle.infoTwo')}</p>
						</div>
						<div className={styles.main__block__middle__right}>
							<p>{t('js.infoMiddle.infoThree')}</p>
							<p>{t('js.infoMiddle.infoFour')}</p>
							<p>{t('js.infoMiddle.infoFive')}</p>
						</div>
					</div>
					<div className={styles.main__block__middle__icon__one}></div>
					<div className={styles.main__block__middle__icon__two}></div>
				</div>
				<div className={styles.main__block__right}>
					<div className={styles.main__block__right__header}>
						<h2>{t('js.program.courses')}</h2>
						<div>
							<img src={icon9} alt='' />
						</div>
						<span>{t('js.program.basis')}</span>
					</div>
					<div className={styles.dropdown} onClick={() => click('one')}>
						<div
							className={one ? styles.dropdown__select : styles.dropdown__sel}
						>
							<span className={styles.select}>{t('js.program.first')}</span>
							<svg
								width='36'
								height='36'
								viewBox='0 0 36 36'
						...
						>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.firstMonth.one')}</a>
							</div>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.firstMonth.two')}</a>
							</div>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.firstMonth.three')}</a>
							</div>
						</div>
					</div>
					<div className={styles.dropdown} onClick={() => click('two')}>
						...
						>
							<span className={styles.select}>{t('js.program.second')}</span>
							<svg
								width='36'
								height='36'
								viewBox='0 0 36 36'
						...
						>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.secondMonth.one')}</a>
							</div>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.secondMonth.two')}</a>
							</div>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.secondMonth.three')}</a>
							</div>
						</div>
					</div>
					<div className={styles.dropdown} onClick={() => click('three')}>
						...
						>
							<span className={styles.select}>{t('js.program.third')}</span>
							<svg
								width='36'
								height='36'
								viewBox='0 0 36 36'
						...
						>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.ThirdMonth.one')}</a>
							</div>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.ThirdMonth.two')}</a>
							</div>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.ThirdMonth.three')}</a>
							</div>
						</div>
					</div>
					<div className={styles.dropdown} onClick={() => click('four')}>
						...
						>
							<span className={styles.select}>{t('js.program.four')}</span>
							<svg
								width='36'
								height='36'
								viewBox='0 0 36 36'
						...
						>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.fourMonth.one')}</a>
							</div>
							<div className={styles.dropdown__list__item}>
								<a href='#'>{t('js.program.fourMonth.two')}</a>
							</div>
						</div>
					</div>
				</div>
